...
z_score_PP <- c("salinity", "SST", "PO4_umol.l", "Si_umol.l", "NO2_umol.l", "NO3_umol.l", "oxygen.umol.l.", "Total.N..nmol.L.", "Total.C..nmol.L.", "C.N.Molar", "Distance_coast.km.", "PPAVG", "chlorophyll")
...
```
#load("~/core_PS113/Genomics/RScripts/20210419_workspace.RData")
...
RDA_plots(list_meta$meta_mixo.z[c(RDA_meta)], list_ASVCounts$ASVCount_mixo.clr, list_ASVCounts$)
...
#plot the diversity against the PL
PL_div%>%
  ggplot()+
  geom_point(aes(x=PL_km, y=Average_auto.euk, color=Province))

plot(PL_div$PL_km, PL_div$Average_auto.euk)
