...
sequencing_statistics <- read.csv("C:/Users/choerstm/Documents/core_PS113/Submission_EnvironmentalMicrobiology/Table_S7_sequencing_statistics.csv", sep = ";")

seq_stats_16S <- sequencing_statistics[c(1:131),]
seq_stats_18S <- sequencing_statistics[c(132:262),]

seq_stats_16S_long <- gather(seq_stats_16S, step, number_reads, input:nonchim, factor_key=TRUE) 
seq_stats_18S_long <- gather(seq_stats_18S, step, number_reads, input:nonchim, factor_key=TRUE) 

a <- ggplot(seq_stats_16S_long, aes(x=number_reads, group=step, fill=step))+
    geom_density(adjust=1.5, alpha=.3) +
    theme_ipsum()

b <- ggplot(seq_stats_18S_long, aes(x=number_reads, group=step, fill=step))+
    geom_density(adjust=1.5, alpha=.3) +
    theme_ipsum()
...
rm(a,b, seq_stats_16S, seq_stats_16S_long, seq_stats_18S, seq_stats_18S_long, sequencing_statistics)
...
RDA_plots(list_meta$meta_auto_euk.z[c(RDA_meta)], list_ASVCounts$ASVCount_18S.tax.auto.clr, list_ASVCounts$ASVCount_18S.tax.auto_ait)
RDA_plots(list_meta$meta_auto_cyano.z[c(RDA_meta)], list_ASVCounts$ASVCount_16S.tax.auto.clr, list_ASVCounts$ASVCount_16S.tax.auto_ait)
RDA_plots(list_meta$meta_mixo.z[c(RDA_meta)], list_ASVCounts$ASVCount_mixo.clr, list_ASVCounts$ASVCount_18S.tax.mixo_ait)
RDA_plots(list_meta$meta_het_euk.z[c(RDA_meta)], list_ASVCounts$ASVCount_18S.tax.het.clr, list_ASVCounts$ASVCount_18S.tax.het_ait)
RDA_plots(list_meta$meta_het_prok.z[c(RDA_meta)], list_ASVCounts$ASVCount_16S.tax.het.clr, list_ASVCounts$ASVCount_16S.tax.het_ait)
#PP
...
source("C:/Users/choerstm/Documents/core_PS113/Genomics/RScripts/PL_aitchinson_distance.R")
ait_auto_16S <-PL_functional_groups(list_ASVCounts$ASVCount_16S.tax.auto_ait,list_meta$meta_functions.PP)
ait_auto_18S <-PL_functional_groups(list_ASVCounts$ASVCount_18S.tax.auto_ait,list_meta$meta_functions.PP)
ait_mixo <-PL_functional_groups(list_ASVCounts$ASVCount_18S.tax.mixo_ait,list_meta$meta_functions.PP)
ait_het_16S <-PL_functional_groups(list_ASVCounts$ASVCount_16S.tax.het_ait,list_meta$meta_functions.PP)
ait_het_18S <-PL_functional_groups(list_ASVCounts$ASVCount_18S.tax.het_ait,list_meta$meta_functions.PP)

ait_auto_16S <-ait_auto_16S%>%cbind(manual_Tax_group = paste0("auto_16S"))
ait_auto_18S <-ait_auto_18S%>%cbind(manual_Tax_group = paste0("auto_18S"))
ait_mixo <-ait_mixo%>%cbind(manual_Tax_group = paste0("mixo"))
ait_het_16S <-ait_het_16S%>%cbind(manual_Tax_group = paste0("het_16S"))
ait_het_18S <-ait_het_18S%>%cbind(manual_Tax_group = paste0("het_18S"))

ait_all <- rbind(ait_auto_16S, ait_auto_18S, ait_mixo, ait_het_16S, ait_het_18S)

#select only neighbouring stations
ait_aut_16S_red <- ait_auto_16S[-c(2,4,5:8,10:32, 36:47, 49:71, 74:81, 83:98, 101:133, 136:149, 152:175, 176:181, 184:209, 212:238, 241:265, 268:293, 296:321, 324:349, 351:368, 370:381, 384:393, 396: 400, 402),]

ait_aut_18S_red <- ait_auto_18S[-c(2,4,5:8,10:32, 36:47, 49:71, 74:81, 83:98, 101:133, 136:149, 152:175, 176:181, 184:209, 212:238, 241:265, 268:293, 296:321, 324:349, 351:368, 370:381, 384:393, 396: 400, 402),]

ait_mixo_red <- ait_mixo[-c(2,4,5:8,10:32, 36:47, 49:71, 74:81, 83:98, 101:133, 136:149, 152:175, 176:181, 184:209, 212:238, 241:265, 268:293, 296:321, 324:349, 351:368, 370:381, 384:393, 396: 400, 402),]

ait_het_16S_red <- ait_het_16S[-c(2,4,5:8,10:32, 36:47, 49:71, 74:81, 83:98, 101:133, 136:149, 152:175, 176:181, 184:209, 212:238, 241:265, 268:293, 296:321, 324:349, 351:368, 370:381, 384:393, 396: 400, 402),]

ait_het_18S_red <- ait_het_18S[-c(2,4,5:8,10:32, 36:47, 49:71, 74:81, 83:98, 101:133, 136:149, 152:175, 176:181, 184:209, 212:238, 241:265, 268:293, 296:321, 324:349, 351:368, 370:381, 384:393, 396: 400, 402),]

ait_all <- rbind(ait_aut_16S_red, ait_aut_18S_red, ait_mixo_red, ait_het_16S_red, ait_het_18S_red)

fit <- lm(distance ~ biomass_transport + manual_Tax_group, data = ait_all)

aa <-ait_all%>%
  ggplot(aes(x=biomass_transport, y=distance, color=province, shape=manual_Tax_group))+
  #geom_smooth(se = FALSE)+
  geom_point()+
  scale_color_manual(values=c("#A64995", "#BDD014", "#2B62FC", "#A331A0", "#CEC521", "#D80E51", "#E85105", "#E58910"))+
...
a <-ait_aut_18S_red%>%dplyr::filter(!province == "BRAZ")%>%
  ggplot()+
  geom_point(aes(x=biomass_transport, y=distance, color=province))+
  scale_color_manual(values=c("#A64995", "#BDD014", "#2B62FC", "#A331A0", "#CEC521", "#D80E51", "#E85105", "#E58910"))+
  theme(axis.title.x = element_text(size=16, vjust = 0.3),
        axis.title.y = element_text(size=16, vjust = 0.3),
        axis.text.y = element_text(size=16, vjust = 0.3),
...
b <-ait_aut_16S_red%>%dplyr::filter(!province == "BRAZ")%>%
  ggplot()+
  geom_point(aes(x=biomass_transport, y=distance, color=province))+
  scale_color_manual(values=c("#A64995", "#BDD014", "#2B62FC", "#A331A0", "#CEC521", "#D80E51", "#E85105", "#E58910"))+
  theme(axis.title.x = element_text(size=16, vjust = 0.3),
...
c <-ait_mixo_red%>%dplyr::filter(!province == "BRAZ")%>%
  ggplot()+
  geom_point(aes(x=biomass_transport, y=distance, color=province))+
  scale_color_manual(values=c("#A64995", "#BDD014", "#2B62FC", "#A331A0", "#CEC521", "#D80E51", "#E85105", "#E58910"))+
  theme(axis.title.x = element_text(size=16, vjust = 0.3),
...
d <-ait_het_18S_red%>%dplyr::filter(!province == "BRAZ")%>%
  ggplot()+
  geom_point(aes(x=biomass_transport, y=distance, color=province))+
  scale_color_manual(values=c("#A64995", "#BDD014", "#2B62FC", "#A331A0", "#CEC521", "#D80E51", "#E85105", "#E58910"))+
  theme(axis.title.x = element_text(size=16, vjust = 0.3),
...
e <-ait_het_16S_red%>%dplyr::filter(!province == "BRAZ")%>%
  ggplot()+
  geom_point(aes(x=biomass_transport, y=distance, color=province))+
  scale_color_manual(values=c("#A64995", "#BDD014", "#2B62FC", "#A331A0", "#CEC521", "#D80E51", "#E85105", "#E58910"))+
  theme(axis.title.x = element_text(size=16, vjust = 0.3),
