...
provinces(list_ASVCounts$ASVCount_16S.tax.auto.clr, list_meta$meta_functions.z)
...
plotNormalHistogram(a.residuals$Shannon.mixo_Shannon.auto.cynao, main = "mixo - cyano")
...
plotNormalHistogram(a.residuals$Shannon.mixo_Shannon.het.euk, main = "mixo - heteuk")
plotNormalHistogram(a.residuals$Shannon.het.euk_Si_umol.l, main = "het.euk - Si")
...
plotNormalHistogram(a.residuals$salinity_Shannon.auto.euk, main = "auto.euk - salinity")
plotNormalHistogram(a.residuals$Shannon.auto.euk_oxygen.umol.l., main = "auto.euk - oxygen")
plotNormalHistogram(a.residuals$Shannon.auto.euk_Total.C..nmol.L., main = "auto.euk - POC")
plotNormalHistogram(a.residuals$Shannon.auto.euk_Total.N..nmol.L., main = "auto.euk - PN")
...
plotNormalHistogram(a.residuals$Shannon.auto.cynao_Total.C..nmol.L., main = "auto.cyano - POC")
plotNormalHistogram(a.residuals$Shannon.auto.cynao_Total.N..nmol.L., main = "auto.cyano - PN")
plotNormalHistogram(a.residuals$Shannon.auto.cynao_chlorophyll, main = "auto.cyano - chla")
plotNormalHistogram(a.residuals$Shannon.mixo_salinity, main = "mixo - salinity")
...
plotNormalHistogram(a.residuals$Shannon.auto.euk_Distance_coast.km., main = "auto.euk - dCoast")
plotNormalHistogram(a.residuals$Shannon.auto.euk_distance_to_province_boundary.km., main = "auto.euk - dBoundary")
plotNormalHistogram(a.residuals$Shannon.auto.euk_PO4_umol.l, main = "auto.euk - PO4")
plotNormalHistogram(a.residuals$Shannon.mixo_distance_to_province_boundary.km., main = "mixo -Boundary")
plotNormalHistogram(a.residuals$Shannon.het.euk_salinity, main = "het.euk - salinity")
plotNormalHistogram(a.residuals$Shannon.het.euk_distance_to_province_boundary.km., main = "het.euk - d.boundary")
plotNormalHistogram(a.residuals$Shannon.het.prok_Shannon.mixo, main = "het.prok_mixo")
...
plotNormalHistogram(a.residuals$Shannon.auto.cynao_distance_to_province_boundary.km., main = "auto.cyano - dBoundary")
plotNormalHistogram(a.residuals$Shannon.auto.cynao_Distance_coast.km., main = "auto.cyano - dCoast")
plotNormalHistogram(a.residuals$Shannon.auto.cynao_SST, main = "auto.cyano - SST")
plotNormalHistogram(a.residuals$Shannon.auto.cynao_Total.N..nmol.L., main = "auto.cyano - PN")
plotNormalHistogram(a.residuals$Shannon.mixo_Distance_coast.km., main = "mixo- d.Coast")
...
plotNormalHistogram(a.residuals$Shannon.auto.euk_distance_to_province_boundary.km., main = "auto.euk - Distance to province boundary")
plotNormalHistogram(a.residuals$Shannon.auto.euk_salinity, main = "auto.euk - salinity")
plotNormalHistogram(a.residuals$Shannon.auto.euk_SST, main = "auto.euk - SST")
plotNormalHistogram(a.residuals$Shannon.auto.euk_PO4_umol.l, main = "auto.euk - PO4")
plotNormalHistogram(a.residuals$Shannon.auto.euk_Total.C..nmol.L., main = "auto.euk - POC")
plotNormalHistogram(a.residuals$Shannon.auto.euk_Total.N..nmol.L., main = "auto.euk - PN")
plotNormalHistogram(a.residuals$Shannon.auto.euk_chlorophyll, main = "auto.euk - chla")
plotNormalHistogram(a.residuals$Shannon.auto.euk_Shannon.auto.cynao, main = "auto.euk - auto.cyano")
plotNormalHistogram(a.residuals$Shannon.auto.cynao_salinity, main = "auto.cyano - salinity")
plotNormalHistogram(a.residuals$Shannon.auto.cynao_Distance_coast.km., main = "auto.cyano - d.Coast")
plotNormalHistogram(a.residuals$Shannon.auto.cynao_distance_to_province_boundary.km., main = "auto.cyano - d.boundary")
...
plotNormalHistogram(a.residuals$Shannon.mixo_Shannon.auto.cynao, main = "mixo - cyano")
plotNormalHistogram(a.residuals$Shannon.mixo_Shannon.het.euk, main = "mixo - het_euk")
plotNormalHistogram(a.residuals$Shannon.mixo_distance_to_province_boundary.km., main = "mixo - distance to province boundary")
...
plotNormalHistogram(a.residuals$Shannon.het.euk_Shannon.auto.euk, main = "het.euk - auto_euk")
plotNormalHistogram(a.residuals$Shannon.het.euk_Shannon.auto.cynao, main = "het.euk - cyano")
plotNormalHistogram(a.residuals$Shannon.het.euk_Distance_coast.km., main = "het.euk - distance to coast")
plotNormalHistogram(a.residuals$Shannon.het.euk_distance_to_province_boundary.km., main = "het.euk - distance to province boundary")
plotNormalHistogram(a.residuals$Shannon.het.euk_salinity, main = "het.euk - salinity")
...
plotNormalHistogram(a.residuals$Shannon.het.prok_Shannon.auto.euk, main = "het.prok - auto_euk")
plotNormalHistogram(a.residuals$Shannon.het.prok_Shannon.het.euk, main = "het.prok - het_euk")
plotNormalHistogram(a.residuals$Shannon.het.prok_SST, main = "het.prok - SST")
plotNormalHistogram(a.residuals$Shannon.het.prok_oxygen.umol.l., main = "het.prok - oxygen")
...
plotNormalHistogram(a.residuals$Shannon.mixo_Shannon.het.euk, main = "mixo - het_euk")
plotNormalHistogram(a.residuals$Shannon.auto.euk_Shannon.het.euk, main = "het_euk_het_auto")
plotNormalHistogram(a.residuals$Shannon.het.prok_Total.C..nmol.L., main = "het.prok - POC")
plotNormalHistogram(a.residuals$Shannon.het.prok_Total.N..nmol.L., main = "het.prok - PN")
...
plotNormalHistogram(a.residuals$Shannon.auto.euk_Total.N..nmol.L., main = "auto.euk - PN")
plotNormalHistogram(a.residuals$Shannon.auto.cynao_salinity, main = "auto.cyano - salinity")
plotNormalHistogram(a.residuals$Shannon.auto.cynao_distance_to_province_boundary.km., main = "auto.cyano - distance to province boundary")
plotNormalHistogram(a.residuals$Shannon.auto.cynao_oxygen.umol.l., main = "auto.cyano - oxygen")
plotNormalHistogram(a.residuals$Shannon.auto.cynao_NO3_umol.l, main = "auto.cyano - NO3")
plotNormalHistogram(a.residuals$Shannon.auto.cynao_Total.C..nmol.L., main = "auto.cyano - POC")
plotNormalHistogram(a.residuals$Shannon.auto.cynao_Total.N..nmol.L., main = "auto.cyano - PN")
plotNormalHistogram(a.residuals$Shannon.auto.cynao_chlorophyll, main = "auto.cyano - chla")
plotNormalHistogram(a.residuals$Shannon.mixo_Distance_coast.km., main = "mixo - distance to coast")
plotNormalHistogram(a.residuals$Shannon.mixo_SST, main = "mixo - SST")
...
plotNormalHistogram(a.residuals$Shannon.het.prok_Shannon.auto.euk, main = "het.prok - auto_euk")
plotNormalHistogram(a.residuals$Shannon.het.prok_Shannon.auto.cynao, main = "het.prok - cyano")
plotNormalHistogram(a.residuals$Shannon.het.prok_Distance_coast.km., main = "het.prok - Distance coast")
plotNormalHistogram(a.residuals$Shannon.het.prok_distance_to_province_boundary.km., main = "het.prok - distance.province.boundary")
plotNormalHistogram(a.residuals$Shannon.het.prok_SST, main = "het.prok - SST")
plotNormalHistogram(a.residuals$Shannon.het.prok_salinity, main = "het.prok - salinity")
...
##PP
provinces(list_ASVCounts$ASVCount_auto_cyano.PP.clr, list_meta$meta_functions.PP.z)

corr_plot_residuals(list_meta$meta_functions.PP.z[subselection_PP])
plotNormalHistogram(a.residuals$Shannon.auto.euk_PPAVG)
plotNormalHistogram(a.residuals$Shannon.auto.cynao_biomass_transport)
plotNormalHistogram(a.residuals$Shannon.mixo_biomass_transport)
plotNormalHistogram(a.residuals$Shannon.mixo_PPAVG, main = "mixo_PP")
plotNormalHistogram(a.residuals$Shannon.het.euk_PPAVG, main = "heteuk_PP")
plotNormalHistogram(a.residuals$Shannon.het.euk_biomass_transport)

corr_plot_residuals(meta_NADR[subselection_PP])
plotNormalHistogram(a.residuals$Shannon.mixo_specific_PP, main = "mixo_PB")
plotNormalHistogram(a.residuals$Shannon.auto.euk_biomass_transport)
plotNormalHistogram(a.residuals$Shannon.auto.cynao_biomass_transport)
plotNormalHistogram(a.residuals$Shannon.mixo_biomass_transport)
plotNormalHistogram(a.residuals$Shannon.het.euk_biomass_transport)
plotNormalHistogram(a.residuals$Shannon.het.prok_biomass_transport)

corr_plot_residuals(meta_NAST[subselection_PP])
plotNormalHistogram(a.residuals$Shannon.het.euk_specific_PP)
...
plotNormalHistogram(a.residuals$Shannon.auto.euk_specific_PP, main = "auto.euk_PB")
plotNormalHistogram(a.residuals$Shannon.auto.cynao_specific_PP, main = "cyano_PB")
plotNormalHistogram(a.residuals$Shannon.auto.cynao_PPAVG, main = "cyano_PP")
plotNormalHistogram(a.residuals$Shannon.auto.euk_biomass_transport)
plotNormalHistogram(a.residuals$Shannon.auto.cynao_biomass_transport)

corr_plot_residuals(meta_WTRA[subselection_PP])
plotNormalHistogram(a.residuals$Shannon.mixo_specific_PP)
plotNormalHistogram(a.residuals$Shannon.mixo_PPAVG, main = "mixo_PP")
plotNormalHistogram(a.residuals$Shannon.mixo_biomass_transport, main = "mixo_PL")
plotNormalHistogram(a.residuals$Shannon.het.euk_specific_PP)

corr_plot_residuals(meta_SATL_hot[subselection_PP])
plotNormalHistogram(a.residuals$Shannon.auto.cynao_specific_PP)
plotNormalHistogram(a.residuals$Shannon.het.euk_biomass_transport)

corr_plot_residuals(meta_SATL_cold[subselection_PP])
plotNormalHistogram(a.residuals$Shannon.auto.euk_PPAVG)
plotNormalHistogram(a.residuals$Shannon.mixo_biomass_transport)
plotNormalHistogram(a.residuals$Shannon.het.euk_PPAVG)

plot_correlations(list_meta$meta_functions.PP.z, list_meta$meta_functions.PP.z$biomass_transport, list_meta$meta_functions.PP.z$Shannon.auto.cynao)
plot_correlations(list_meta$meta_functions.PP.z, list_meta$meta_functions.PP.z$biomass_transport, list_meta$meta_functions.PP.z$Shannon.mixo)
plot_correlations(list_meta$meta_functions.PP.z, list_meta$meta_functions.PP.z$biomass_transport, list_meta$meta_functions.PP.z$Shannon.het.euk)
