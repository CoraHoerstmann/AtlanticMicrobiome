...
#PREFILTERING
filterAndTrim(fnFs.raw,fnFs.preFilt,fnRs.raw,fnRs.preFilt,truncQ=2,minQ=2,minLen=50,maxN=0,multithread = 8)
...
saveRDS(seqtab, file = "seqtabPS113_18S.RDA")
write.csv(t(seqtab), "seqtab_PS113_18S.csv", quote=FALSE )
...
saveRDS(seqtab.nochim, file = "seqtab.nochim.PS113_18S.RDA")
write.csv(t(seqtab.nochim), "seqtab.nochim_PS113_18S.csv", quote=FALSE )
